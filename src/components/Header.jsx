      ...
      <div className="container mx-auto px-4 py-4 max-w-7xl">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-6 items-center">
            ...
            {/* Assuming an About page might exist */}
            <Link to="/signup" className="text-gray-700 hover:text-black">
              Sign Up
            </Link>
          </nav>
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex gap-4 items-center bg-gray-100 px-3 py-2 rounded-md">
              <input
                type="text"
        ...
        {isMobileMenuOpen && (
          <nav className="mt-4 md:hidden flex flex-col space-y-2">
            <Link
              ...
              className="text-gray-700 hover:text-black py-2 border-b"
            >
              Home
            </Link>
            <Link
            ...
            <Link
              to="/login"
              onClick={() => setIsMobileMenuOpen(false)}
              className="text-gray-700 hover:text-black py-2 border-t"
            >
              Log In
            </Link>
            <Link
